import type { CreateJobRequest, FormFieldErrors, IllustrationType, SpreadLayout } from "./types.js";
import { ageGroups, illustrationTypes, spreadLayouts } from "./types.js";
...
export function validateCreateJobRequest(input: CreateJobRequest): FormFieldErrors {
  ...
  } else if (!(ageGroups as readonly string[]).includes(input.ageGroup)) {
